...
Qui, all'inizio del XI secolo, il [vescovo](http://it.wikipedia.org/wiki/Vescovo "Vescovo") [Fulberto](http://it.wikipedia.org/wiki/Fulberto_di_Chartres "Fulberto di Chartres"), [teologo](http://it.wikipedia.org/wiki/Teologo "Teologo") [scolastico](http://it.wikipedia.org/wiki/Scolastica_%28filosofia%29 "Scolastica (filosofia)") apprezzato in tutta Europa, iniziò la costruzione di uno dei migliori esempi esistenti di architettura gotica.

Edificato su un'altura che era già luogo di culto dei Celti, il complesso sorge su un pozzo da sempre considerato sacro, tutt'oggi esistente e profondo ben 37 metri.<!--more-->

**Il numero 37 torna spesso nel racconto della [Cattedrale](http://it.wikipedia.org/wiki/Cattedrale_di_Chartres "wiki").**
...
Distrutta da un incendio nel 1194, da cui si salvarono le sculture ancora visibile sulla facciata occidentale, la Cattedrale venne ricostruita in tempi lunghi, tanto che la torre di nord-est, la _Cloche Neuf,_ fu ultimata solo nel 1513.
...
Infatti, alcuni sostengono che le iscrizioni presenti su una delle colonne esterne "nascondano" il trasporto e la custodia all'interno della cattedrale di uno dei miti medievali più famosi: l'_Arca dell'Alleanza._
...
\[gallery type="slideshow" link="file" ids="837,839,844,841,840,842,843,838,846"\]

Come spesso ci racconta la storia di quel periodo, quindi, anche per la Cattedrale di Chartres valgono i tanti misteri, affascinanti ed irrisolti, del Medio Evo europeo, con tanto di cavalieri, druidi, elementi astronomici e pagani che si fondono continuamente con la religione ed il divino.
...
Un luogo che profuma di magico e sacro e che regala [una visita di grande fascino](http://it.wikipedia.org/wiki/Patrimonio_dell%27umanit%C3%A0 "UNESCO").

_\[Video & Photo: Marco Bena\]_
